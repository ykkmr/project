...
<!-- header start -->
    <header class="header">
        <div class="main_nav">
            <div>
                <h1 class="title"><a href="main_all.do"><img src="http://localhost/ss/common/images/%EC%83%81%ED%95%98%EC%9D%98%EC%8A%A4%ED%8A%B8%EB%A6%BF.png"></a></h1>
                <ul class="navigation">
                    <li><a href="http://localhost/team_prj2/prj2/product/guest_prod_top.jsp" style="color: black">TOP</a></li> <!-- 링크수정필요 -->
                    <li><a href="http://localhost/team_prj2/prj2/product/guest_prod_bottom.jsp" style="color: black">BOTTOM</a></li> <!-- 링크수정필요 -->
                    <li><a href="http://localhost/team_prj2/prj2/lookbook/lookbook_main.jsp" style="color: black">LOOKBOOK</a></li> <!-- 링크수정필요 -->
                    <li><a href="http://localhost/team_prj2/prj2/login/member.jsp" style="color: black">MYPAGE</a></li> <!-- 링크수정필요 -->
                </ul>
            </div>
            <ul class="icons">
               ...
               <%--      <%
                    ...
                    if( userId == null  ){
                    %> --%>
                    <a href="http://localhost/team_prj2/prj2/login/login.jsp"> <!-- 링크수정필요 -->
                ...
                <li>
                    <p>cart</p>
                    <a href="http://localhost/team_prj2/prj2/order/orderDetail.jsp"> <!-- 링크수정필요 -->
